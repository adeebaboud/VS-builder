...
$(document).ready(function () {
    ...
    var handleMobileOverlay = function() {
      ...
      if ($(window).width() < 768) {
        ...
        $(document).off("click", '.mobile-sticky-body-overlay');
    ...
    var handleSidebarMenu = function() {
      var sidebar = $(".sidebar");
      if (sidebar.length != 0) {
        $(".sidebar .nav > .has-sub > a").off("click").on("click", function() {
          $(this).parent().siblings().removeClass('expand');
          $(this).parent().toggleClass('expand');
  
        });
  
        $(".sidebar .nav > .has-sub .has-sub > a").off("click").on("click", function() {
          $(this).parent().toggleClass('expand');
    ...
    var handleSidebarToggleForMobile = function() {
      if ($(window).width() < 768) {
        $(document).on("click", "#sidebar-toggler", function(e) {
          e.preventDefault();
    ...
    var handleSidebarToggleForDesktop = function() {
      var body = $("#body");
      if ($(window).width() >= 768) {
    ...
    var handleWindowResize = function() {
      ...
      // Reset sidebar classes based on window width
      if ($(window).width() < 768) {
        body.removeClass("sidebar-minified sidebar-collapse sidebar-mobile-out");
        window.isMinified = false;
        window.isCollapsed = false;
      ...
      handleMobileOverlay();
      handleSidebarMenu();
      handleSidebarToggleForMobile();
      handleSidebarToggleForDesktop();
    };
    ...
    if (hoverableDataTable.length !== 0){
      hoverableDataTable.DataTable({
        "aLengthMenu": [[10, 30, 50, 75, -1], [20, 30, 50, 75, "All"]],
        "pageLength": 10,
        "dom": '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">'
      });
    }
